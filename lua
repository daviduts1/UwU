...
KeySystemUI.New({
    ApplicationName = "Edward Newgate Hub", -- Your Key System Application Name
...
W:AddLabel("Script Quả Edward Newgate")
...
W:AddLabel("Shop : edwardnewgate.site")
W:AddLabel("sever discord : discord.gg/edwardnewgate")
W:AddButton({
	Name = "nhấn vào đây để sao chép link discord",
	Callback = function()
...
local localrace = W:AddLabel("tộc")
...
local localbeli = W:AddLabel("tiền")
...
local localfrag = W:AddLabel("điểm tím")
...
local localDevil = W:AddLabel("trái ác quỷ")
                ...
                function()
                    if
                     ...
                     then
                        ...
                        localDevil:Set("Không có trái ác quỷ")
                    end
                end
            )
        end
...
local Section =
    M:AddSection(
    {
        Name = "Trang trại khác"
    }
)

M:AddParagraph("Đổi mã", "Nhấp vào nút để đổi tất cả mã trong Blox Fruits.")
...
M:AddParagraph("Trang trại chính", "Click to Box to Farm, tôi đã sẵn sàng cập nhật trang trại mob mới!.")
...
local Section =
    M:AddSection(
    {
        Name = "Thực đơn vua bột"
    }
)

M:AddToggle(
    {
        Name = "tự động đánh Katakuri",
        Default = false,
        Flag = "Auto Katakuri",
        Save = true,
        Callback = function(Value)
...
M:AddToggle(
    {
        Name = "tự động  Katakuri v2[dịch chuyển]",
        Default = false,
...
M:AddParagraph("Menu Mastery", "Click vào hộp để bắt đầu làm chủ trang trại")
...
local Bring = {"Thấp", "Bình thường", "siêu nhanh"}
_G.BringMode = "Normal"
M:AddDropdown(
    {
        Name = "cách fam",
    ...
    function()
        while wait(.1) do
            if _G.BringMode then
                pcall(
                    function()
                        if _G.BringMode == "Thấp" then
                            _G.BringMode = 300
                        elseif _G.BringMode == "Bình thường" then
                            _G.BringMode = 375
                        elseif _G.BringMode == "Siêu nhanh" then
                            _G.BringMode = 450
                        end
                    end
                )
...
M:AddToggle({Name = "Kaitun",Default = false,Flag = "Kaitun",Save = true,Callback = function(Value)
            _G.RedeemCode = Value
            _G.AutoFarm = Value
            _G.Farmfast = Value
...
M:AddToggle(
    {
        Name = "Rương tự động [dịch chuyển]",
        Default = false,
...
M:AddToggle(
    {
        Name = "tự động dừng khi có key râu đen hoặc chén thánh",
        Default = false,
        Flag = "tự động dừng khi có key râu đen hoặc chén thánh",
        Save = true,
        Callback = function(Value)
            _G.StopChest = Value
        end
...
local Section =
    M:AddSection(
    {
        Name = "tự động farm điểm haki quan sát"
    }
)
...
M:AddToggle(
    {
        Name = "tự động farm điểm haki quan sát[đổi sever]",
        Default = false,
            ...
            pcall(
                function()
                    if
                     ...
                     then
                        SaberBoss:Set("Boss Saber : ✅ có")
                    else
                        SaberBoss:Set("Boss Saber : ❌ không có")
                    end
                end
            )
        end
...
IQ:AddToggle(
    {
        Name = "tự động lấy Saber[đổi sever]",
        Default = false,
        Flag = "Auto Saber[HOP]",
        Save = true,
        Callback = function(Value)
            ...
            pcall(
                function()
                    if
                     ...
                     then
                        PoleBoss:Set("Boss Thunder : ✅ có ")
                    else
                        PoleBoss:Set("Boss Thunder : ❌ không có")
                    end
                end
            )
        end
...
TogglePolev1Hop =
    IQ:AddToggle(
    {
        Name = "tự động lấy Pole V.1[đổi sever]",
        Default = false,
        Flag = "Auto Pole[HOP]",
        Save = true,
        Callback = function(Value)
...
BartiloToggle =
    IQ:AddToggle(
    {
        Name = "tự động làm nhiện vụ Bartilo",
        Default = false,
        Flag = "Auto Bartilo",
        Save = true,
        Callback = function(Value)
...
IQ:AddToggle(
    {
        Name = "tự động lấy kiếm Buddy[đổi sever]",
        Default = false,
        Flag = "Auto Buddy[HOP]",
        Save = true,
        Callback = function(Value)
...
IQ:AddToggle(
    {
        Name = "tự động lấy Soul Guita[đổi sever]",
        Default = false,
        Flag = "Auto Soul[HOP]",
        Save = true,
        Callback = function(Value)
...
IQ:AddToggle(
    {
        Name = "tự động lấy Tushita[đổi sever]",
        Default = false,
...
IQ:AddToggle(
    {
        Name = "tự động lấy Cavander[đổi sever]",
        Default = false,
...
IQ:AddToggle(
    {
        Name = "tự động lấy Twin Hook[đổi sever]",
        Default = false,
        Flag = "Auto Twin[HOP]",
        Save = true,
        Callback = function(Value)
...
IQ:AddToggle(
    {
        Name = "Tự động đánh giả[đổi sever]",
        Default = false,
        Flag = "Auto dummy[HOP]",
        Save = true,
        Callback = function(Value)
...
ToggleHallow =
    IQ:AddToggle(
    {
        Name = "tự động lấy Hallow Scythe[đổi sever]",
        Default = false,
...
IQ:AddToggle(
    {
        Name = "tự động lấy Dark Dragger[đổi sever]",
        Default = false,
        Flag = "Auto Dark[HOP]",
        Save = true,
        Callback = function(Value)
...
IQ:AddToggle(
    {
        Name = "tự động đánh Seabeast[đổi sever]",
        Default = false,
...
Chest = S:AddLabel("rương")

Fruit = S:AddLabel("trái ác quỷ")

local Pointstat = S:AddLabel("tiền")
    ...
    function()
        while wait() do
            pcall(
                function()
                    Pointstat:Set(
                        "tiền : " .. tostring(game:GetService("Players")["LocalPlayer"].Data.Points.Value)
                    )
                end
            )
        end
...
local Melee = S:AddLabel("cận chiến : ")
local Defense = S:AddLabel("phòng thủ : ")
local Sword = S:AddLabel("kiếm : ")
local Gun = S:AddLabel("súng : ")
local Fruit = S:AddLabel("trái ác quỷ : ")
...
spawn(
    function()
        while wait() do
            pcall(
                function()
                    Fruit:Set("trái ác quỷ : " .. game.Players.localPlayer.Data.Stats["Demon Fruit"].Level.Value)
                end
            )
        end
    end
...
S:AddToggle(
    {
        Name = "tự động thống kê theo Kaitun",
        Default = false,
        Flag = "Auto Kaitun",
        Save = true,
        Callback = function(Value)
...
local TimeRaid = RA:AddLabel("Chờ ngục tối")

local checkisland = RA:AddLabel("đảo : không có ai Raid")
...
local Section =
    SV:AddSection(
    {
        Name = "Kiểm tra trăng tròn"
    }
)

local FM = SV:AddLabel("Giờ máy chủ : " .. function8() .. " | " .. CheckMoon() .. " | " .. function7())

spawn(
    function()
        while wait() do
            FM:Set("Giờ máy chủ : " .. function8() .. " | " .. CheckMoon() .. " | " .. function7())
        end
    end
)
...
local Section =
    SV:AddSection(
    {
        Name = "Kiểm tra một lần của khách hàng"
    }
)
...
local Elite_Hunter_Status = SV:AddLabel("Chỉ có biển 3")
            ...
            pcall(
                function()
                    if
                     ...
                     then
                        Elite_Hunter_Status:Set("Elite : ✅ có ")
                    else
                        Elite_Hunter_Status:Set("Elite : ❌ không có")
                    end
                end
            )
        end
...
Mirragecheck = SV:AddLabel("Chỉ có biển 3 ")

local Section =
    SV:AddSection(
    {
        Name = "kiểm tra Dough King"
    }
)

local MobKilled = SV:AddLabel("Chỉ có biển 3")
...
local Section =
    SV:AddSection(
    {
        Name = "chuyển sever tìm"
    }
)

SV:AddToggle(
    {
        Name = "đổi sever tìm trăng 3/4 và 4/4",
        Default = false,
        Flag = "FindFM",
        Save = true,
        Callback = function(Value)
...
D:AddToggle(
    {
        Name = "tự động lưu trái ác quỷ vào balo",
        Default = false,
...
D:AddToggle(
    {
        Name = "dịch chuyển đến trái ác quỷ Sinh sản",
        Default = false,
...
D:AddToggle(
    {
        Name = "Mang theo tất cả trái cây [Klick 75%]",
        Default = false,
...
R:AddButton(
    {
        Name = "dịch chuyển đến bánh răng",
        Callback = function()
            _G.TweenMGear = Value
...
R:AddButton(
    {
        Name = "Dịch chuyển lên trên cây đại thụ",
        Callback = function()
            TweenTempleLegit()
        end
    }
...
R:AddButton(
    {
        Name = "Dịch chuyển đến kéo cần gạt",
        Callback = function()
            PullLever()
        end
    }
...
R:AddButton(
    {
        Name = "Dịch chuyển đến Anclient One",
        Callback = function()
            Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame =
                CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
            Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame =
...
R:AddButton(
    {
        Name = "dịch chuyển đến cửa của tộc",
        Callback = function()
            Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame =
                CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
            wait(.1)
...
local Section =
    R:AddSection(
    {
        Name = "Các thử nghiệm khác"
    }
)

R:AddToggle(
    {
        Name = "tự động hoàn thành Trials",
        Default = false,
...
R:AddToggle(
    {
        Name = "tự động đánh người up tộc",
        Default = false,
        Flag = "KillTrials",
        Save = true,
        Callback = function(Value)
...
SH:AddButton(
    {
        Name = "tự động mua tộc người máy :",
        Callback = function()
            local a = {
                [1] = "CyborgTrainer",
                [2] = "Buy"
...
SH:AddButton(
    {
        Name = "Súng trường kỳ quái [ 250 vật chất kì dị ]",
        Callback = function()
            local A_1 = "Ectoplasm"
            local A_2 = "Buy"
            local A_3 = 1
...
SH:AddButton(
    {
        Name = "reset chỉ số[2,500 điểm tím]",
        Callback = function()
...
OrionLib:MakeNotification(
    {
        Name = "Edward Newgate Hub",
        Content = "Đang tải tập lệnh hoàn tất!, Bây giờ bạn có thể kích hoạt chức năng!",
        Time = 5
    }
)
...
OrionLib:MakeNotification(
    {
        Name = "Edward Newgate Hub",
        Content = "https://discord.gg/edwardnewgate",
        Time = 5
    }
)
...
ImageButton.Image = "https://www.roblox.com/asset/?id=16088640168"
